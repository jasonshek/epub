...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text2',
                            type: 'text',
                            rect: ['87px', '371px', '565px', '97px', 'auto', 'auto'],
                            text: "下面這些聲音是哪些動物發出來的？請把和它們相關的圖畫拖放到灰色格子內。",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("d-08_edgeActions.js");
})("EDGE-20141121-P2");
