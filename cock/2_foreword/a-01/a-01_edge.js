                    ...
                    dom: [
                        {
                            ...
                            display: 'block',
                            type: 'text',
                            rect: ['83px', '263px', '575px', '853px', 'auto', 'auto'],
                            text: "　　對於學齡前的孩子來說，聽故事、說故事和讀故事，都是他們樂此不疲的有趣事情，也是他們成長過程中一個非常重要的經驗。在媽媽、老師那溫馨親切的笑語裏，孩子一邊看圖畫，一邊聽故事，他已初步嘗到了「讀書」的樂趣。接着，再在媽媽、老師的教導下，自己學會說故事、讀故事，那更是給了孩子巨大的成功感。<br>　　精選家喻戶曉的著名童話，配上富有童趣的彩色插畫動畫，透過簡單易用的應用程式重新演繹，讓孩子看圖畫，說故事，訓練孩子說故事、讀故事的能力。此外，本應用程式故事後附的「字詞表」也有助於孩子學習語文──詞語由故事內的詞彙擴展到故事外，讓孩子重溫故事內的字詞及學習新字詞，豐富了孩子的詞彙量；而「字詞 遊樂園」也透過互動字詞小練習，增加了閱讀的趣味性。",
                            align: "justify",
