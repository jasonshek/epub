...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/1.8.mp3'],
                            id: '_18',
                            rect: ['281', '967', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        },
                        {
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid1865", "trigger", 0, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_18}', [] ] ]
                    ]
                }
            }
        };
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("b-10m_edgeActions.js");
})("EDGE-20141121-P8");
