...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         // insert code here
         sym.getSymbol("symbols_animation_p2").stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 15750, function(sym, e) {
         ...
         if (!sym.getSymbol("symbols_animation_p2").isPlaying() ) {
         	sym.getSymbol("symbols_animation_p2").play(0);
      ...
      Symbol.bindElementAction(compId, symbolName, "${play_btn}", "click", function(sym, e) {
         ...
         sym.getSymbol("symbols_animation_p2").play();
         
         // Set a toggle to hide or show an element 
         if (!sym.$("symbols_animation_p2").is(':visible')){
         	sym.$("play_btn").show();
         	} else {
         	sym.$("play_btn").hide();
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${bu_l}", "click", function(sym, e) {
         window.open("../b-03/b-03.html", "_self");
   ...
   //Edge symbol: 'symbols_animation_p2'
   (function(symbolName) {   
   
   })("symbols_animation_p2");
   //Edge symbol end:'symbols_animation_p2'

})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-20141121-P2");