...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         // insert code here
         sym.getSymbol("symbols_animation_p3").stop();

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 22912, function(sym, e) {
         // Replay from the beginning, regardless of current playing state 
         if (!sym.getSymbol("symbols_animation_p3").isPlaying() ) {
         	sym.getSymbol("symbols_animation_p3").play(0);
      ...
      Symbol.bindElementAction(compId, symbolName, "${play_btn}", "click", function(sym, e) {
         ...
         sym.getSymbol("symbols_animation_p3").play();
         
         // Set a toggle to hide or show an element 
         if (!sym.$("symbols_animation_p3").is(':visible')){
         	sym.$("play_btn").show();
         	} else {
         	sym.$("play_btn").hide();
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${bu_l}", "click", function(sym, e) {
         window.open("../b-04m/b-04m.html", "_self");
      ...
      Symbol.bindElementAction(compId, symbolName, "${bu_cantonese}", "click", function(sym, e) {
         window.open("../b-05/b-05.html", "_self");
   ...
   //Edge symbol: 'symbols_animation_p3'
   (function(symbolName) {   
   
   })("symbols_animation_p3");
   //Edge symbol end:'symbols_animation_p3'
