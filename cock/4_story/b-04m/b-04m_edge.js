...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/1.2.mp3'],
                            id: '_12',
                            rect: ['257', '705', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        },
                        {
                            ...
                            id: 'test0',
                            text: '小公雞來到花園裏，要和小蜜蜂比一比。小蜜蜂　嗡嗡叫：「我要採花蜜，沒空跟你比。」',
                            align: 'left',
                            type: 'text'
                        },
                        {
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid1370", "trigger", 0, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_12}', [] ] ]
                    ]
                }
            }
        };
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("b-04m_edgeActions.js");
})("EDGE-20141121-P2");
