...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            preload: 'auto',
                            type: 'audio',
                            source: ['media/1.6.mp3'],
                            id: '_16',
                            rect: ['233', '736', '320px', '45px', 'auto', 'auto'],
                            display: 'none',
                            tag: 'audio'
                        },
                        {
                    ...
                    style: {
                        '${symbolSelector}': {
                            isStage: 'true',
                            rect: [undefined, undefined, '827px', '780px']
                        }
                    }
                },
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid1935", "trigger", 0, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['play', '${_16}', [] ] ]
                    ]
                }
            }
        };
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("b-08m_edgeActions.js");
})("EDGE-20141121-P6");
