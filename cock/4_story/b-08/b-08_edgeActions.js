...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         // insert code here
         sym.getSymbol("symbols_animation_p6").stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 14000, function(sym, e) {
         ...
         if (!sym.getSymbol("symbols_animation_p6").isPlaying() ) {
         	sym.getSymbol("symbols_animation_p6").play(0);
      ...
      Symbol.bindElementAction(compId, symbolName, "${play_btn}", "click", function(sym, e) {
         ...
         sym.getSymbol("symbols_animation_p6").play();
         
         // Set a toggle to hide or show an element 
         if (!sym.$("symbols_animation_p6").is(':visible')){
         	sym.$("play_btn").show();
         	} else {
         	sym.$("play_btn").hide();
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${bu_r}", "click", function(sym, e) {
         ...
         window.open("../b-09/b-09.html", "_self");
   ...
   //Edge symbol: 'symbols_animation_p6'
   (function(symbolName) {   
   
   })("symbols_animation_p6");
   //Edge symbol end:'symbols_animation_p6'

})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-20141121-P6");