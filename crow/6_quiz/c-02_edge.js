...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "小朋友，故事中的小烏鴉是不是很聰明？我們也來做個聰明的小朋友，玩玩「加減識字法」遊戲。請仿照下面的例子，把正確答案拖放到橫線上方。 ",
                            align: "left",
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("c-02_edgeActions.js");
})("EDGE-20141121-P3");
